...
var ApartmentWhere = struct {
	...
	CreatedAt:  whereHelpertime_Time{field: "\"apartment\".\"created_at\""},
	UpdatedAt:  whereHelpertime_Time{field: "\"apartment\".\"updated_at\""},
}
...
var (
	apartmentAllColumns            = []string{"id", "building_id", "number", "floor", "sq_meters", "created_at", "updated_at"}
	apartmentColumnsWithoutDefault = []string{"building_id", "number", "floor", "sq_meters", "created_at", "updated_at"}
...
// OneG returns a single apartment record from the query using the global executor.
func (q apartmentQuery) OneG(ctx context.Context) (*Apartment, error) {
...
// AllG returns all Apartment records from the query using the global executor.
func (q apartmentQuery) AllG(ctx context.Context) (ApartmentSlice, error) {
...
// CountG returns the count of all Apartment records in the query using the global executor
func (q apartmentQuery) CountG(ctx context.Context) (int64, error) {
...
func (q apartmentQuery) ExistsG(ctx context.Context) (bool, error) {
...
// SetBuildingG of the apartment to the related item.
// Sets o.R.Building to related.
// Adds o to related.R.Apartments.
// Uses the global database handle.
func (o *Apartment) SetBuildingG(ctx context.Context, insert bool, related *Building) error {
	return o.SetBuilding(ctx, boil.GetContextDB(), insert, related)
}
...
// FindApartmentG retrieves a single record by ID.
func FindApartmentG(ctx context.Context, iD int, selectCols ...string) (*Apartment, error) {
	return FindApartment(ctx, boil.GetContextDB(), iD, selectCols...)
}
...
func (o *Apartment) InsertG(ctx context.Context, columns boil.Columns) error {
...
// UpdateG a single Apartment record using the global executor.
// See Update for more documentation.
func (o *Apartment) UpdateG(ctx context.Context, columns boil.Columns) (int64, error) {
...
func (q apartmentQuery) UpdateAllG(ctx context.Context, cols M) (int64, error) {
...
// UpdateAllG updates all rows with the specified column values.
func (o ApartmentSlice) UpdateAllG(ctx context.Context, cols M) (int64, error) {
...
func (o *Apartment) UpsertG(ctx context.Context, updateOnConflict bool, conflictColumns []string, updateColumns, insertColumns boil.Columns, opts ...UpsertOptionFunc) error {
...
// DeleteG deletes a single Apartment record.
// DeleteG will match against the primary key column to find the record to delete.
func (o *Apartment) DeleteG(ctx context.Context) (int64, error) {
...
func (q apartmentQuery) DeleteAllG(ctx context.Context) (int64, error) {
...
func (o ApartmentSlice) DeleteAllG(ctx context.Context) (int64, error) {
...
func (o *Apartment) ReloadG(ctx context.Context) error {
	if o == nil {
		return errors.New("models: no Apartment provided for reload")
	}
...
func (o *ApartmentSlice) ReloadAllG(ctx context.Context) error {
	if o == nil {
		return errors.New("models: empty ApartmentSlice provided for reload all")
	}
...
// ApartmentExistsG checks if the Apartment row exists.
func ApartmentExistsG(ctx context.Context, iD int) (bool, error) {
	return ApartmentExists(ctx, boil.GetContextDB(), iD)
}
